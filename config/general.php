...
function getPropuestas() {
    ...
    $query = $db->prepare($sql);
    $query->execute();
    $propuestas = $query->fetchAll(PDO::FETCH_ASSOC);
    foreach ($propuestas as &$propuesta){
        $propuesta['descripcion'] = wpautop($propuesta['descripcion']);
    }
    
    return $propuestas;
}

function getAdherentes() {
     global $db;
    $sql = 'SELECT * FROM adherentes';
    $query = $db->prepare($sql);
    $query->execute();
    $adherentes = $query->fetchAll(PDO::FETCH_ASSOC);
